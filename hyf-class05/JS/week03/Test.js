...
function getCurrentAge(person) {
    var age = today.year - person.dob_year;
    
    if (today.month <= person.dob_month || today.month > person.dob_month && today.day < person.dob_day || today.day> person.dob_day)  {
...
for (let person of allPersons) {
  console.log(person.name, "is", getCurrentAge(person), "years", person.dob_month, "months and", person.dob_day, "days old." );
}
